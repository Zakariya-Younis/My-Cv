...
export function LinkedInIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20.452 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.447-2.136 2.944v5.662H9.356V9h3.414v1.561h.049c.476-.9 1.637-1.852 3.369-1.852 3.604 0 4.27 2.373 4.27 5.459v6.284zM5.337 7.433a2.062 2.062 0 11.001-4.124 2.062 2.062 0 01-.001 4.124zM6.814 20.452H3.861V9h2.953v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.225.792 24 1.771 24h20.451C23.2 24 24 23.225 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
    </svg>
  );
}
...
export function JavaScriptIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    ...
    >
      ...
      <path d="M2 0h20a2 2 0 012 2v20a2 2 0 01-2 2H2a2 2 0 01-2-2V2a2 2 0 012-2zm11.6 17.7c.5.9 1.2 1.6 2.5 1.6 1.1 0 1.8-.6 1.8-1.4 0-1-.8-1.3-2-1.8l-.7-.3c-2-.9-3.3-2-3.3-4.3 0-2.1 1.6-3.7 4.1-3.7 1.8 0 3.1.6 4 2.2l-2.2 1.4c-.5-.9-1-1.2-1.8-1.2s-1.4.6-1.4 1.2c0 .8.6 1.2 1.9 1.8l.7.3c2.3 1 3.6 2.1 3.6 4.4 0 2.5-2 3.9-4.6 3.9-2.6 0-4.2-1.2-5.1-2.8l2.5-1.5zM7.3 18.2c.4.7.8 1.2 1.8 1.2.9 0 1.5-.4 1.5-1.8V7.9h2.9v9.7c0 3-1.7 4.3-4.1 4.3-2.2 0-3.5-1.1-4.2-2.4l2.1-1.3z" />
    </svg>
  );
}
...
export function PythonIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    ...
    >
      ...
      <path d="M12.002 1.5c-2.2 0-3.6.2-4.6.6-1.1.4-1.8 1-2.1 1.8-.3.8-.3 1.8-.3 3.2v2.4h7.1v1.6H2.902c-1.7 0-3.2 1.5-3.2 3.2v2.1c0 1.4.5 2.4 1.3 3.2.9.8 2.1 1.3 3.6 1.7 1.5.3 3.2.5 5.3.5 2.1 0 3.8-.2 5.3-.5 1.5-.3 2.7-.8 3.6-1.6.9-.8 1.3-1.8 1.3-3.2v-2.6h-7.1v-1.6h9.2c1.7 0 3.2-1.5 3.2-3.2V7.1c0-1.4-.5-2.4-1.3-3.2-.9-.8-2.1-1.3-3.6-1.7-1.5-.3-3.2-.5-5.3-.5zm-2.9 2.4c.6 0 1 .5 1 1s-.5 1-1 1-1-.5-1-1 .4-1 1-1zm5.8 16.2c.6 0 1 .5 1 1s-.5 1-1 1-1-.5-1-1 .4-1 1-1z" />
    </svg>
  );
}
