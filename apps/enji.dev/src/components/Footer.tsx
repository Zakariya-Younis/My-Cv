  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Zakariya Younis Al‑Shuaibi, a <strong>software engineer</strong>
        specializing in Python, JavaScript, and the MERN stack. I enjoy
        building AI/ML, web, and mobile projects.
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://linkedin.com/in/zakariya-al-shuaibi-6a2a1a28b"
            target="_blank"
            rel="noreferrer nofollow"
        ...
        <li>
          <a
            href="https://github.com/Zakariya-Younis"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
      ...
      <div className={clsx('content-wrapper')}>
        <div className={clsx('py-10 font-semibold')}>
          <div className={clsx('flex flex-col-reverse gap-16', 'lg:flex-row')}>
            ...
            >
              {/* Footer link groups removed as requested */}
            </div>
          </div>
        </div>
        <div
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Zakariya Younis Al‑Shuaibi
          </div>
          <div className={clsx('text-slate-500', 'dark:text-slate-400')}>{/* removed last update link */}</div>
        </div>
      </div>
    </footer>
  );
